            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Cadastro de Setor</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form method="POST" id="form" action="${pageContext.request.contextPath}/setorController" onsubmit="checkForm(this)">
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            <label for="inputMar">Nome do Setor</label>
                                            <input class="form-control" type="text" name="nomeSetor" placeholder="Nome do Setor" maxlength="45" required>
                                        </div>
                                    </div>
